...
function PhoneMockup() {
  ...
  return (
    <div className="phone-mockup relative mx-auto w-[260px] sm:w-[280px]">
      {/* Phone frame */}
      <div className="relative rounded-[2rem] border-[3px] border-border p-2 shadow-2xl shadow-black/20">
        {/* Notch */}
        <div className="absolute left-1/2 top-0 z-10 h-5 w-20 -translate-x-1/2 -translate-y-px rounded-b-2xl bg-border" />

        {/* Screen */}
        <div className="overflow-hidden rounded-[1.5rem] bg-background">
          {/* Status bar */}
          <div className="flex items-center justify-between px-5 pt-3 pb-1">
            <span className="text-[9px] font-semibold text-muted">9:41</span>
            <div className="flex items-center gap-1">
              <div className="h-2 w-3 rounded-sm border border-border" />
          ...
          <div className="flex items-center gap-2 px-4 pb-2 pt-1">
            ...
            <div>
              <p className="text-[10px] font-semibold text-foreground">BBDU CSE</p>
          ...
          <div className="mx-3 rounded-lg border border-border bg-surface p-2.5">
            <p className="text-[7px] font-semibold uppercase tracking-[0.15em] text-muted">
              Continue Learning
            </p>
            {firstSubject ? (
              <>
                <p className="mt-1 text-[9px] font-semibold text-foreground truncate">
            ...
            <div className="mt-1.5 flex items-center gap-2">
              ...
              <span className="text-[7px] font-semibold tabular-nums text-muted">
                {s1.pct}%
              </span>
            </div>
          </div>
          ...
          <div className="px-3 pt-2.5 pb-3 space-y-1.5">
            <p className="text-[7px] font-semibold uppercase tracking-[0.15em] text-muted px-1">
              Subjects
            </p>
            {subjects.slice(0, 3).map((s, i) => {
              ...
              return (
                ...
                >
                  <span className="text-[7px] font-semibold text-muted tabular-nums w-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-0.5 h-px w-full overflow-hidden bg-border">
                      <div
...
export default function InstallSection() {
  ...
  return (
    ...
    >
      {/* Subtle bronze radial glow */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_0%,rgba(176,138,90,0.04),transparent)]" />
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-18">
        <div className="flex flex-col items-center gap-10 lg:flex-row lg:items-center lg:gap-16">
          ...
          >
            ...
            <h2 className="mt-5 font-display text-2xl font-medium tracking-tight text-foreground sm:text-3xl lg:text-4xl">
              Your study hub,
              <br />
              one tap away.
            </h2>
            ...
            <div className="mt-6 grid grid-cols-1 gap-2.5 sm:grid-cols-2 mx-auto max-w-md lg:mx-0">
              {[
                ...
                <div
                  key={benefit.text}
                  className="flex items-center gap-2.5 rounded-md bg-tinted px-3 py-2"
                >
                  <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded bg-accent/10 text-accent">
            ...
            <div className="mt-8">
              {showInstallButton && (
                <div className="flex flex-col items-center gap-2 sm:flex-row lg:justify-start">
                  <button
                    ...
                    className="group inline-flex items-center gap-2.5 rounded-md bg-accent px-6 py-3 text-[14px] font-semibold text-background transition-all hover:bg-accent-hover active:translate-y-0"
              ...
              {showInstalledBadge && (
                <div className="flex items-center gap-2 rounded-md bg-success/10 px-5 py-3">
                ...
                <div className="rounded-lg border border-border bg-surface p-5">
                  ...
                  <ol className="space-y-2 text-[13px] text-muted">
                    <li className="flex items-start gap-2">
                      <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded bg-accent/10 text-[10px] font-semibold text-accent">
                        1
                      </span>
              ...
              {!showInstallButton && !showInstalledBadge && !showIOSGuide && (
                <div className="flex flex-col items-center gap-2 sm:flex-row lg:justify-start">
                  <div className="inline-flex items-center gap-2 rounded-md border border-border bg-surface-hover px-5 py-3 text-[13px] text-muted">
