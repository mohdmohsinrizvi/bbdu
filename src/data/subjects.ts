...
export const bbduSubjects: Subject[] = [
  ...
  {
    id: "electrical-engineering-concepts",
    code: "REE5101",
    name: "Electrical Engineering Concepts",
    category: "ESC",
    type: "theory",
    credits: 3,
    lectureHours: 3,
    tutorialHours: 0,
    practicalHours: 0,
    prerequisite: "Basic knowledge of Physics",
    objectives: [
      "To understand fundamental concepts of electrical engineering including DC and AC circuits.",
      "To learn about transformers, electrical machines, and their applications.",
      "To understand power generation, transmission, and distribution systems.",
      "To develop knowledge of electrical safety and energy conservation.",
    ],
    outcomes: [
      "CO1: Analyze DC and AC circuit behavior using Kirchhoff's laws and network theorems.",
      "CO2: Understand working principles of transformers and electrical machines.",
      "CO3: Evaluate power generation, transmission, and distribution systems.",
      "CO4: Apply electrical safety practices and energy conservation techniques.",
    ],
    units: [
      {
        id: "unit-1",
        ...
        description: "Fundamental concepts of DC circuits, laws, and network theorems.",
        contactHours: 15,
        mappedCO: ["CO1"],
        topics: [
          { id: "dc-circuit-fundamentals", title: "DC Circuit Fundamentals", description: "Understanding voltage, current, resistance, and power in DC circuits.", orderIndex: 1 },
          { id: "kirchhoffs-laws", title: "Kirchhoff's Laws", description: "Applying KCL and KVL to solve circuit problems.", orderIndex: 2 },
          { id: "network-theorems", title: "Network Theorems", description: "Thevenin, Norton, Superposition, and Maximum Power Transfer theorems.", orderIndex: 3 },
          { id: "mesh-and-nodal-analysis", title: "Mesh and Nodal Analysis", description: "Systematic methods for analyzing complex circuits.", orderIndex: 4 },
        ],
      },
      {
        id: "unit-2",
        ...
        description: "Analysis of single-phase and three-phase AC circuits.",
        contactHours: 15,
        mappedCO: ["CO1"],
        topics: [
          { id: "ac-fundamentals", title: "AC Fundamentals", description: "Understanding sinusoidal waveforms, impedance, and phasor diagrams.", orderIndex: 1 },
          { id: "single-phase-ac-circuits", title: "Single Phase AC Circuits", description: "Analysis of RL, RC, and RLC circuits under AC excitation.", orderIndex: 2 },
          { id: "three-phase-ac-circuits", title: "Three Phase AC Circuits", description: "Understanding balanced and unbalanced three-phase systems.", orderIndex: 3 },
          { id: "power-factor-and-correction", title: "Power Factor & Correction", description: "Understanding power factor, its significance, and methods of improvement.", orderIndex: 4 },
        ],
      },
      {
        id: "unit-3",
        ...
        description: "Working principles of transformers, DC motors, and AC motors.",
        contactHours: 15,
        mappedCO: ["CO2"],
        topics: [
          { id: "transformer-principles", title: "Transformer Principles", description: "Understanding construction, working, and testing of single-phase transformers.", orderIndex: 1 },
          { id: "dc-machines", title: "DC Machines", description: "Construction, working principle, and applications of DC generators and motors.", orderIndex: 2 },
          { id: "induction-motors", title: "Induction Motors", description: "Working principle, construction, and characteristics of induction motors.", orderIndex: 3 },
          { id: "synchronous-machines", title: "Synchronous Machines", description: "Understanding synchronous generators and motors.", orderIndex: 4 },
        ],
      },
      {
        id: "unit-4",
        number: 4,
        title: "Power Systems & Safety",
        description: "Power generation, transmission, distribution, and electrical safety.",
        contactHours: 15,
        mappedCO: ["CO3", "CO4"],
        topics: [
          { id: "power-generation", title: "Power Generation", description: "Understanding conventional and renewable energy sources for power generation.", orderIndex: 1 },
          { id: "transmission-and-distribution", title: "Transmission & Distribution", description: "Learning about transmission lines, substations, and distribution systems.", orderIndex: 2 },
          { id: "electrical-safety", title: "Electrical Safety", description: "Understanding electrical hazards, safety practices, and protective devices.", orderIndex: 3 },
          { id: "energy-conservation", title: "Energy Conservation", description: "Methods and technologies for efficient energy utilization.", orderIndex: 4 },
        ],
      },
    ],
  },
  {
    id: "sustainable-chemical-sciences",
    code: "RBS5102",
    name: "Sustainable Chemical Sciences",
    category: "BSC",
    type: "theory",
    credits: 4,
    lectureHours: 3,
    ...
    objectives: [
      "To understand fundamental concepts of chemistry relevant to engineering applications.",
      "To learn about water chemistry, air chemistry, and material chemistry.",
      "To understand energy sources, chemical processes, and sustainability.",
      "To develop awareness about green chemistry and environmental chemistry.",
    ],
    outcomes: [
      "CO1: Apply fundamental chemical concepts to engineering problems.",
      "CO2: Analyze water and air chemistry for environmental applications.",
      "CO3: Understand energy sources and chemical processes in industry.",
      "CO4: Evaluate green chemistry principles and sustainable practices.",
    ],
    units: [
      {
        id: "unit-1",
        ...
        mappedCO: ["CO1"],
        topics: [
          { id: "atomic-structure-and-periodicity", title: "Atomic Structure & Periodicity", description: "Understanding atomic models, electronic configuration, and periodic properties.", orderIndex: 1 },
          { id: "chemical-bonding", title: "Chemical Bonding", description: "Ionic, covalent, and metallic bonding and their significance.", orderIndex: 2 },
          { id: "chemical-thermodynamics", title: "Chemical Thermodynamics", description: "Energy changes in chemical reactions, enthalpy, entropy, and Gibbs free energy.", orderIndex: 3 },
          { id: "chemical-kinetics", title: "Chemical Kinetics", description: "Rate of reactions, factors affecting rates, and reaction mechanisms.", orderIndex: 4 },
        ],
      },
      {
        id: "unit-2",
        number: 2,
        title: "Water & Air Chemistry",
        description: "Chemistry of water and air for environmental engineering applications.",
        contactHours: 15,
        mappedCO: ["CO2"],
        topics: [
          { id: "water-chemistry", title: "Water Chemistry", description: "Understanding pH, hardness, alkalinity, and water treatment chemistry.", orderIndex: 1 },
          { id: "water-pollution-chemistry", title: "Water Pollution Chemistry", description: "Chemical contaminants in water and their analysis.", orderIndex: 2 },
          { id: "air-chemistry", title: "Air Chemistry", description: "Atmospheric chemistry, pollutants, and their effects.", orderIndex: 3 },
          { id: "instrumental-methods", title: "Instrumental Methods", description: "Spectroscopic and chromatographic methods of analysis.", orderIndex: 4 },
        ],
      },
      {
        id: "unit-3",
        number: 3,
        title: "Energy & Industrial Chemistry",
        description: "Chemical processes in energy production and industrial applications.",
        contactHours: 15,
        mappedCO: ["CO3"],
        topics: [
          { id: "energy-sources-and-fuels", title: "Energy Sources & Fuels", description: "Conventional and alternative energy sources and fuel chemistry.", orderIndex: 1 },
          { id: "electrochemistry", title: "Electrochemistry", description: "Electrochemical cells, batteries, and corrosion.", orderIndex: 2 },
          { id: "polymers-and-materials", title: "Polymers & Materials", description: "Introduction to polymer chemistry and advanced materials.", orderIndex: 3 },
          { id: "industrial-processes", title: "Industrial Processes", description: "Chemical processes in manufacturing and industry.", orderIndex: 4 },
        ],
      },
      {
        id: "unit-4",
        ...
        description: "Principles of green chemistry and sustainable chemical practices.",
        contactHours: 15,
        mappedCO: ["CO4"],
        topics: [
          { id: "green-chemistry-principles", title: "Green Chemistry Principles", description: "Understanding the 12 principles of green chemistry.", orderIndex: 1 },
          { id: "sustainable-processes", title: "Sustainable Processes", description: "Designing environmentally friendly chemical processes.", orderIndex: 2 },
          { id: "waste-minimization", title: "Waste Minimization", description: "Methods for reducing chemical waste and recycling.", orderIndex: 3 },
          { id: "environmental-impact", title: "Environmental Impact", description: "Assessing and mitigating environmental impact of chemical processes.", orderIndex: 4 },
        ],
      },
    ],
  },
  {
    id: "professional-workplace-communication",
    code: "RHSA5101",
    name: "Professional and Workplace Communication",
    category: "BSC",
    type: "theory",
    credits: 3,
    lectureHours: 3,
    ...
    prerequisite: "None",
    objectives: [
      "To develop professional communication skills for the workplace.",
      "To understand business writing, presentation, and interpersonal communication.",
      "To learn email etiquette, report writing, and meeting communication.",
      "To build confidence in professional interactions and teamwork.",
    ],
    outcomes: [
      "CO1: Demonstrate effective professional communication in written and oral forms.",
      "CO2: Prepare business documents including reports, emails, and proposals.",
      "CO3: Deliver professional presentations with confidence.",
      "CO4: Apply interpersonal and teamwork communication skills in workplace scenarios.",
    ],
    units: [
      {
        id: "unit-1",
        ...
        description: "Communication process, barriers, and professional communication principles.",
        contactHours: 15,
        mappedCO: ["CO1"],
        topics: [
          { id: "communication-process", title: "Communication Process", description: "Understanding the communication cycle, types, and models.", orderIndex: 1 },
          { id: "communication-barriers", title: "Communication Barriers", description: "Identifying and overcoming physical, psychological, and semantic barriers.", orderIndex: 2 },
          { id: "professional-etiquette", title: "Professional Etiquette", description: "Workplace etiquette, dress code, and professional behavior.", orderIndex: 3 },
          { id: "listening-skills", title: "Listening Skills", description: "Active listening techniques and their importance in professional settings.", orderIndex: 4 },
        ],
      },
      {
        id: "unit-2",
        ...
        description: "Professional document writing including emails, reports, and proposals.",
        contactHours: 15,
        mappedCO: ["CO2"],
        topics: [
          { id: "email-etiquette", title: "Email Etiquette", description: "Writing professional emails with proper tone, structure, and formatting.", orderIndex: 1 },
          { id: "report-writing", title: "Report Writing", description: "Structure and format of technical and business reports.", orderIndex: 2 },
          { id: "proposal-writing", title: "Proposal Writing", description: "Writing effective business proposals and project proposals.", orderIndex: 3 },
          { id: "resume-and-cover-letter", title: "Resume & Cover Letter", description: "Creating professional resumes and compelling cover letters.", orderIndex: 4 },
        ],
      },
      {
        id: "unit-3",
        number: 3,
        title: "Oral Communication & Presentations",
        description: "Public speaking, presentation skills, and meeting communication.",
        contactHours: 15,
        mappedCO: ["CO3"],
        topics: [
          { id: "public-speaking", title: "Public Speaking", description: "Techniques for effective public speaking and overcoming stage fear.", orderIndex: 1 },
          { id: "presentation-skills", title: "Presentation Skills", description: "Creating and delivering professional presentations.", orderIndex: 2 },
          { id: "meeting-communication", title: "Meeting Communication", description: "Participating in and conducting professional meetings.", orderIndex: 3 },
          { id: "interview-skills", title: "Interview Skills", description: "Preparing for and performing in professional interviews.", orderIndex: 4 },
        ],
      },
      {
        id: "unit-4",
        ...
        description: "Teamwork, cross-cultural communication, and workplace relationships.",
        contactHours: 15,
        mappedCO: ["CO4"],
        topics: [
          { id: "interpersonal-communication", title: "Interpersonal Communication", description: "Building professional relationships and effective interpersonal skills.", orderIndex: 1 },
          { id: "teamwork-and-collaboration", title: "Teamwork & Collaboration", description: "Working effectively in teams and collaborative environments.", orderIndex: 2 },
          { id: "cross-cultural-communication", title: "Cross-Cultural Communication", description: "Understanding and navigating cultural differences in communication.", orderIndex: 3 },
          { id: "conflict-resolution", title: "Conflict Resolution", description: "Managing and resolving workplace conflicts effectively.", orderIndex: 4 },
        ],
      },
    ],
  },
  {
    id: "basics-of-artificial-intelligence",
    code: "RCS5102",
    ...
    tutorialHours: 0,
    practicalHours: 0,
    prerequisite: "Basic knowledge of Mathematics and Logic",
    objectives: [
      "To understand fundamental concepts of artificial intelligence.",
      "To learn about search algorithms, knowledge representation, and machine learning basics.",
      "To understand natural language processing and computer vision concepts.",
      "To explore real-world applications of AI in engineering.",
    ],
    outcomes: [
      "CO1: Demonstrate understanding of AI fundamentals and intelligent agents.",
      "CO2: Apply search algorithms to solve AI problems.",
      "CO3: Understand knowledge representation and reasoning techniques.",
      "CO4: Evaluate AI applications in real-world engineering scenarios.",
    ],
    units: [
      {
        id: "unit-1",
        ...
        description: "AI fundamentals, intelligent agents, and problem-solving approaches.",
        contactHours: 15,
        mappedCO: ["CO1"],
        topics: [
          { id: "what-is-ai", title: "What is AI", description: "Understanding AI definition, history, and branches of AI.", orderIndex: 1 },
          { id: "intelligent-agents", title: "Intelligent Agents", description: "Types of agents, agent environment, and agent architectures.", orderIndex: 2 },
          { id: "problem-solving-agents", title: "Problem Solving Agents", description: "Formulating problems as search and defining problem spaces.", orderIndex: 3 },
          { id: "ai-applications", title: "AI Applications", description: "Exploring AI applications in healthcare, finance, transportation, and more.", orderIndex: 4 },
        ],
      },
      {
        id: "unit-2",
        ...
        description: "Uninformed and informed search strategies for problem solving.",
        contactHours: 15,
        mappedCO: ["CO2"],
        topics: [
          { id: "uninformed-search", title: "Uninformed Search", description: "BFS, DFS, and other blind search algorithms.", orderIndex: 1 },
          { id: "informed-search", title: "Informed Search", description: "A*, greedy best-first search, and heuristic functions.", orderIndex: 2 },
          { id: "adversarial-search", title: "Adversarial Search", description: "Game playing, minimax algorithm, and alpha-beta pruning.", orderIndex: 3 },
          { id: "constraint-satisfaction", title: "Constraint Satisfaction", description: "Solving constraint satisfaction problems in AI.", orderIndex: 4 },
        ],
      },
      {
        id: "unit-3",
        ...
        description: "Representing and reasoning with knowledge in AI systems.",
        contactHours: 15,
        mappedCO: ["CO3"],
        topics: [
          { id: "logic-and-reasoning", title: "Logic & Reasoning", description: "Propositional and predicate logic for knowledge representation.", orderIndex: 1 },
          { id: "expert-systems", title: "Expert Systems", description: "Building expert systems with rule-based knowledge representation.", orderIndex: 2 },
          { id: "ontology-and-semantic-networks", title: "Ontology & Semantic Networks", description: "Representing knowledge using ontologies and semantic networks.", orderIndex: 3 },
          { id: "fuzzy-logic", title: "Fuzzy Logic", description: "Handling uncertainty and imprecision in AI reasoning.", orderIndex: 4 },
        ],
      },
      {
        id: "unit-4",
        number: 4,
        title: "Machine Learning Basics & Applications",
        description: "Introduction to machine learning and real-world AI applications.",
        contactHours: 15,
        mappedCO: ["CO4"],
        topics: [
          { id: "machine-learning-introduction", title: "Machine Learning Introduction", description: "Supervised, unsupervised, and reinforcement learning overview.", orderIndex: 1 },
          { id: "neural-networks-basics", title: "Neural Networks Basics", description: "Understanding perceptrons, activation functions, and basic neural networks.", orderIndex: 2 },
          { id: "natural-language-processing", title: "Natural Language Processing", description: "Text processing, sentiment analysis, and language models.", orderIndex: 3 },
          { id: "computer-vision-basics", title: "Computer Vision Basics", description: "Image processing, object detection, and facial recognition concepts.", orderIndex: 4 },
        ],
      },
    ],
  },
  {
    id: "electrical-engineering-lab",
    code: "REE5151",
  ...
  {
    id: "sustainable-chemical-sciences-lab",
    code: "RBS5152",
    name: "Sustainable Chemical Sciences Lab",
    category: "BSC",
    type: "lab",
    credits: 1,
    lectureHours: 0,
